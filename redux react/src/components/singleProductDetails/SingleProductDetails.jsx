  ...
  return (
    <>
      ...
      <div className='flex justify-center my-10'>
        <div className="card card-side w-[70%]  rounded-xl bg-base-200 shadow-xl">
          <div className='w-[30%]'>
          ...
          <div className="card-body w-[70%] ">
            ...
            <div className="card-actions justify-end">
              <button className="btn font-bold bg-sky-300 hover:bg-sky-400 " onClick={productAddToCart} > Add to Cart </button>
            </div>
          </div>
        </div>
      </div>
